                ...
                <div class="imgFont">
                  ...
                  <div class="styleInfo">
                    <van-row>
                      ...
                      <van-col span="12">
                        <p class="pFont" style="text-align: right">相同数:{{item.sameCount}}</p>
                      </van-col>
                    </van-row>
                    <van-row>
                      <van-col span="12">
                        <p class="pFont" style="text-align: left">档期数:{{item.scheduleCount}}</p>
                      </van-col>
                      <van-col span="12">
                        <p class="pFont" style="text-align: right">档期天数:{{item.scheduleCountDay}}</p>
                      </van-col>
                    </van-row>
                  </div>
                </div>
